...
# 받는사람 입력 
browser.find_element_by_css_selector("#toInput").send_keys("gold7942feel@naver.com")
time.sleep(2)

# 제목 입력
browser.find_element_by_css_selector("#subject").send_keys("셀레니움 만으로 자동화 할거임")
time.sleep(2)
...
# 본문 입력
browser.find_element_by_css_selector(".se2_inputarea").send_keys("셀레니움 만으로 본문 입력함")
time.sleep(2)
